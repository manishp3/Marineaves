...
function EditShipScheduling() {
  ...
  useEffect(()=>{
    const userRowData = async () =>{
        const getUserData = await fetch(`http://localhost/marinewaves/ShipScheduling.php/${id}`);
        const resUserData = await getUserData.json();
        setShipInfo(resUserData);
      ...
      <div className="container">
        <form onSubmit={handleSubmit}>
          ...
          <section className="p-md-5 m-4">
            <h2 className="py-3 text-center">Update Ship Schedule </h2>
            <div className="row">
              ...
              <div className="form-group col-md-3">
                ...
                <div className="input-group">
                  <input
                    ...
                    value={shipInfo.estimatedDuration}
                    onChange={handleInput}
                  />
                  <div className="input-group-append">
                    <span className="input-group-text">
...
export default EditShipScheduling;
