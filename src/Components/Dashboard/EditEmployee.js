  ...
  useEffect(() => {
    const getUserData = async () => {
      const reqData = await fetch(
        "http://localhost/marinewaves/CompanyStaff.php/" + id
      );
      const resData = await reqData.json();
      console.log(resData);
      setStaffInfo(resData);
    };
    getUserData();
  }, []);
            ...
            <div className="form-group col-md-3">
              <div className="input-group">
                <select
                  ...
                  value={staffInfo.employeeDepartment}
                  onChange={handleInput}
                >
            ...
            <div className="form-group col-md-3">
              ...
              <div className="input-group">
                ...
                <input
                  ...
                  value={staffInfo.employeePhoneNumber}
                  onChange={handleInput}
                />
              </div>
            </div>
            ...
            <div className="form-group col-md-3">
              ...
              <div className="input-group">
                <input
                  ...
                  value={staffInfo.employeeJoiningDate}
                  onChange={handleInput}
                />
                <div className="input-group-append">
                  <span className="input-group-text">
            ...
            <div className="form-group col-md-3">
              ...
              <div className="input-group">
                <select
                  ...
                  value={staffInfo.employeeWorkingHours}
                  onChange={handleInput}
                >
