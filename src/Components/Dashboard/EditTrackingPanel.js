...
function EditTrackingPanel() {
  ...
  useEffect(() => {
    ...
    //----------api to get data of specific ship-----------
    const shipRowData = async()=>{
      const getShipData = await fetch("http://localhost/MarineWaves/TrackingInsert.php/"+id);
      const shipData = await getShipData.json();
              ...
              <div className="form-group col-md-4">
                <div className="input-group">
                  <select
                    ...
                    value={shipInfo.currentLocation}
                    onChange={handleInput}
                  >
              ...
              <div className="form-group col-md-3">
                ...
                <div className="input-group">
                  <input
                    ...
                    value={shipInfo.estimatedTimeOfArriaval}
                    onChange={handleInput}
                  />
                  <div className="input-group-append">
                    <span className="input-group-text">
...
export default EditTrackingPanel;
